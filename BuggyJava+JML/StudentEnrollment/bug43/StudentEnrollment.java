public class StudentEnrollment {
    ...
    public void enrollmentProcess(int passedCredits, int semesterCredits, int payment, int initialBalance, boolean lateRegistration, boolean debit, boolean option) 
	 ...
	 String firstName = getFirstName();
         if (initialBalance > maxSemesterCredits * costPerCredit + maxSemesterCredits * ((costPerCredit/100)*6)) {//if (initialBalance <= maxSemesterCredits * costPerCredit + maxSemesterCredits * ((costPerCredit/100)*6)) {
