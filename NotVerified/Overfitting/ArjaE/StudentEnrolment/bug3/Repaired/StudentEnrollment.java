public class StudentEnrollment {
    ...
    {
        if (0 < passedCredits && passedCredits <= totalCredits || this.tuitionBalance <= 0) { //if (0 < passedCredits && passedCredits <= totalCredits) { //if (0 <= passedCredits && passedCredits <= totalCredits) {
