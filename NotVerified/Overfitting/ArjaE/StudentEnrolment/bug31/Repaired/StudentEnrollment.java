public class StudentEnrollment {
    ...
    {
	int maxTuitionBalance=maxSemesterCredits * costPerCredit + maxSemesterCredits * ((enrollmentCredits / 100) * 6);//int maxTuitionBalance = maxSemesterCredits * costPerCredit + maxSemesterCredits * ((costPerCredit/100)*6);
